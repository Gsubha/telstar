        ...
        if ($highestColumn == 'AB') {
            for ($row = 1; $row <= $highestRow; $row++) {
                ...
                if(!empty($user->id))
                {
                    ...
                    if(isset($umodel->profileUser->user_id)){
                        if($umodel->profileUser->user_id == $user->id){
                    ...
                    if(isset($umodel->vehicleUser->user_id)){
                        if($umodel->vehicleUser->user_id == $user->id){
                    ...
                    if(isset($umodel->officialUser->user_id)){
                        if($umodel->officialUser->user_id == $user->id){
